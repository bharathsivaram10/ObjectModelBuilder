%% Authors %%
% Bharath Sivaram, Isaac Kasahara, Chase Anderson 

%% Sections 1: Data Collection: Set device info and visualization params %%
...
%% Section 2: Take 30 frames of depth images and save into an array
...
%% Section 3: Loop through all images to convert to PointClouds and filter out everything but backpack
